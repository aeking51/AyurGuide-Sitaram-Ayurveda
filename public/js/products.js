    ...
    return `
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-[#E2D9CC] p-4 shadow-xs space-y-3">
          ...
          <div class="flex flex-wrap items-center justify-between text-xs text-gray-500 pt-2 border-t border-gray-100">
            <div class="flex items-center gap-2">
            ...
            <div class="text-[11px] text-gray-400">Sorted by Updated Date</div>
          </div>
        </div>
                ...
                <div class="space-y-1.5">
                  ${(p.packings || []).map(pk => `
                    <div class="flex items-center justify-between p-2 rounded bg-white border border-gray-200 text-xs">
                      ...
                      <span class="text-[10px] text-emerald-700 font-semibold bg-emerald-50 px-2 py-0.5 rounded">Standard Stock</span>
                    </div>
                  `).join('')}
                </div>
              </div>
